...
class ReceptionistApp:
    def __init__(self, root):
        ...
        self.title_label = tk.Label(root, text="Doctor Status", font=("Arial", 16, "bold"), bg="#ffffff")
    ...
    def draw_status_circle(self, parent, color):
        canvas = tk.Canvas(parent, width=30, height=30, bg="#ffffff", highlightthickness=0)
